...
local make_backdrop = function(f)
	f:SetFrameLevel(20)
	f:SetPoint("TOPLEFT",-4.5,4.5)
	f:SetPoint("BOTTOMRIGHT",4.5,-4.5)
	f:SetBackdrop(backdrop_tab);
	f:SetBackdropColor(0,0,0,0)
	f:SetBackdropBorderColor(0,0,0,1)
end

local make_border = function(f)
...
for i = 1, 3 do
	...
	teduration:SetFont(cfg.font, cfg.timefontsize, "OUTLINE")
...
local function CreateBuffStyle(buttonName, i, debuff)
	...
	if icon and not _G[buttonName..i.."Background"] then
		...
		duration:SetFont(cfg.font, cfg.timefontsize, "OUTLINE")
