...
L["%s not queued! Min restock of %s is higher than max restock of %s"] = "%s 不制造！最小的补货量%s比最大补货量%s大"
L["2H Weapon"] = "双手武器"
L["Accept"] = "接受"
L["Add Crafted Items from this Group to Auctioning Groups"] = "添加该分组中已制造物品到销售部拍卖分组"
L["Add Item to New Group"] = "添加物品到新的分组"
L["Add Item to Selected Group"] = "添加物品到所选分组"
L["Add Item to TSM_Auctioning"] = "添加物品到销售部"
L["Added %s crafted items to %s individual groups."] = "新增 %s 已制造物品到单独的分组 %s 。"
L["Added %s crafted items to: %s."] = "新增 %s 已制造物品到：%s。"
L["Additional Item Settings"] = "额外设置"
L["Addon to use for alt data:"] = "插件使用小号数据："
L["Adds all items in this Crafting group to Auctioning group(s) as per the above settings."] = "参照上面的设置添加该制造项目分组的所有物品到销售部拍卖分组。"
L["AH/Bags/Bank/Alts"] = "AH/包/银/小号"
L["Alchemy was not found so the craft queue has been disabled."] = "炼金专业未找到，制造队列已被禁用。"
L["Alchemy"] = "炼金"
...
L["Allows you to set a custom minimum queue quantity for this item."] = "允许你为该物品设置加入队列的最小值"
...
L["AuctionDB - Market Value"] = "市场分析部的市场价"
L["AuctionDB - Minimum Buyout"] = "市场分析部的最低一口价"
...
L["Blacksmithing was not found so the craft queue has been disabled."] = "锻造专业未找到，制造队列已被禁用。"
L["Blacksmithing"] = "锻造"
L["Blue Gems"] = "蓝色宝石"
L["Boots"] = "靴子"
L["Bracers"] = "护腕"
L["Buy From Vendor"] = "从供应商购买"
L["Can not set a max restock quantity below the minimum restock quantity of %d."] = "最大补货量不能小于最小补货量(%d)"
L["Can not set a min restock quantity above the max restock quantity of %d."] = "最小补货量不能大于最大补货量(%d)"
L["Cancel"] = "取消"
L["Category to put groups into:"] = "将分组添加到分类中："
L["Celestial Ink"] = "苍穹墨水"
L["Characters to include:"] = "包含角色："
...
L["Double Click Queue"] = "双击队列"
L["Druid"] = "德鲁伊"
L["Edit Custom Value"] = "编辑自定义价"
L["Elixir"] = "药剂"
L["Enable / Disable showing this craft in the craft management window."] = "启用/禁用该制造在生产部界面中显示。"
...
L["If checked, Crafting will account for items you have on the AH."] = "拍卖行的物品数量也计算入制造项目的数量内。"
...
L["Ignore Vendor Items"] = "忽略供应商物品"
L["In Bags"] = "在背包中"
L["Include Crafts Already in a Group"] = "包括分组中已就绪制造项目。"
L["Include Items on AH"] = "包括已拍卖物品"
...
L["Level 71+"] = "71+级"
L["Limit Vendor Item Price"] = "限制供应商物品价格"
L["Lion's Ink"] = "狮王墨水"
L["Mage"] = "法师"
L["Manual Entry"] = "手动输入"
...
L["Maximum Price Per Vendor Item"] = "每个供应商物品的最高价格"
L["Meta Gems"] = "多彩宝石"
L["Midnight Ink"] = "午夜墨水"
L["Mill"] = "磨草"
L["Milling"] = "研磨"
...
L["Potion"] = "药水"
L["Price / Inventory Settings"] = "价格/库存设置"
...
L["Profession Page Settings"] = "专业页面设置"
...
L["Set Crafted Item Cost to Auctioning Fallback"] = "将已制造物品的成本价设置为销售部的回跌价"
L["Shaman"] = "萨满祭司"
L["Shield"] = "盾牌"
...
L["Tailoring"] = "裁缝"
L["The checkboxes in next to each craft determine enable / disable the craft being shown in the Craft Management Window."] = "下列可制造物品名称前面的复选框，是用来设置启用/禁用它在生产界面中的选项。"
...
L["These options control the \"Restock Queue\" button in the craft management window. These settings can be overriden by profession or by item in the profession pages of the main TSM window."] = "这些选项用于生产部的\"补货队列\"，可以修改TSM主窗口的专业修改或专业物品页。"
...
L["Warning: This page requires v0.2.2 or higher of the main TSM addon. Please update yours in order to view this page. http://wow.curse.com/downloads/wow-addons/details/tradeskill-master.aspx"] = "警告：本页面需要宅工厂v0.2.2或更高版本的支持。请访问http://wow.curse.com/downloads/wow-addons/details/tradeskill-master.aspx更新到新版本的宅工厂。"
...
L["You can click on one of the rows of the scrolling table below to view or adjust how the price of a material is calculated."] = "在下列框中任意一列点击可查看或调整已计算好的原材料价格。"
