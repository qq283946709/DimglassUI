...
local cfg = {
    ...
    scale = 0.9,
    point = { "BOTTOMRIGHT", "BOTTOMRIGHT", -80, 200 },
    cursor = false,
    ...
    backdrop = {
        ...
        edgeFile = "Interface\\AddOns\\FreebTip\\media\\Tooltips\\UI-Tooltip-Border",
        tile = false,
        tileSize = 16,
        edgeSize = 20,
        insets = { left = 3, right = 3, top = 3, bottom = 3 },
    },
    bgcolor = { r=0.05, g=0.05, b=0.05, t=0.7 },
...
local function setBakdrop(frame)
	...
	frame.shadow:SetPoint("TOPLEFT", frame, -2, 2)
	frame.shadow:SetPoint("BOTTOMRIGHT", frame, 2, -2)
	frame.shadow:SetBackdrop({
		edgeFile = "Interface\\AddOns\\FreebTip\\media\\glowTex",
		edgeSize = 5,
		insets = {
			top = 4,
			bottom = 4,
