...
function makeIlvl(frame, slot)
	...
	if not iLvl then
		...
		isValid = iLvlText:SetFont("Fonts\\Hooge.ttf", 10, "monochromeoutline")
...
function makeDurability(frame, slot)
	...
	if not iDura then
		...
		isValid = iDuraText:SetFont("Fonts\\Hooge.ttf", 10, "monochromeoutline")
...
function makeMod(frame, slot)
	...
	if not iMod then
		...
		isValid = iModText:SetFont("Fonts\\Hooge.ttf", 10, "monochromeoutline")
