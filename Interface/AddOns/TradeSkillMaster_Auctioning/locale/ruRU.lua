...
L["Allows you to manually adjust the buyout price you want to post this item for. This is a one-time adjustment and will no effect your settings."] = "Здесь можно вручную изменить цены выкупа предмета. Это действие не изменит ваших настроек."
...
L["Auctioning - Post Scan"] = "Auctioning - Выставить"
...
L["Auctions will be posted at a price such that they are undercutting the cheapest auction above your threshold when the market goes below your threshold."] = "Если цена выкупа самого дешевого лота меньше \"нижней\" границы, то ваши лоты будут выставлены по цене, перебивающий самый дешевый лот над \"нижней\" границей."
...
L["Buyout Per Item"] = "Выкуп за предмет"
L["Buyout: %s"] = "Выкуп: %s"
L["CTRL"] = "CTRL"
L["Cancel"] = "Отмена"
...
L["Change Post Price"] = "Изменить цену выкупа"
...
L["Close this window and discard the price entered above."] = "Закрыть окно и не применять изменения."
L["Close this window and save the price entered above as the new buyout price (new bid calculated automatically)."] = "Закрыть окно и сохранить введенную цену как новую цену выкупа для этого предмета (цена ставки будет определена автоматически)."
...
L["Enter a gold value to set the buyout price of this item to. Must be in #g#s#c format (ie \"3g40s\")."] = "Введите цену выкупа для этого предмета в формате #g#s#c (например \"3g40s\")."
...
L["Lists the current auctions for this item."] = "Показать текущие лоты этого предмета."
L["Log"] = "Лог"
...
L["New"] = "Новый"
L["New Buyout Price"] = "Новая цена выкупа."
...
L["Prevents Auctioneer from scanning while Auctioning is doing a scan."] = "Не давать сканировать аддону Auctioneer во время сканирования модуля Auctioning."
L["Prevents the scanning of items in groups that are disabled (for post and cancel scans) or set to not auto cancel (for cancel scans only)."] = "Не сканировать предметы в группах, которые отключены для выставления или авто отмены."
...
L["Smart scanning"] = "\"Умное\" сканирование."
...
L["Total value of your auctions:"] = "Общая стоимость ваших аукционов."
L[ [=[TradeSkillMaster_Auctioning has detected that you have APM/ZA/QA3 running.

Please disable APM/ZA/QA3 by clicking on the OK button below.]=] ] = [=[TradeSkillMaster_Auctioning обнаружил, что у вас запущен аддон APM/ZA/QA3.

Пожалуйста, отключите APM/ZA/QA3, нажав кнопку ОК.]=]
L["Uncategorized Groups:"] = "Группы без категорий:"
...
L["When posting, ignore auctions with more than %s items or less than %s items in them. Ingoring the lowest auction if the price difference between the lowest two auctions is more than %s. Items in this group will not be canceled automatically."] = "Игнорировать во время выставления лоты с большим чем %s и меньшим чем %s количеством предметов. Игнорировать самый дешевый лот, если разница выкупа двух самых дешевых лотов больше %s. Предметы в этой группе не будут отменяться автоматически."
